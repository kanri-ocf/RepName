Public Class fOutCash
    ...
    Protected Overrides ReadOnly Property CreateParams() As System.Windows.Forms.CreateParams
        ...
        End Get
    End Property
    Private Sub fOutCash_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'スタッフ入力ウィンドウ表示
        ...
        adjust_form = New cAdjustLib.fAdjustCount(oConn, oCommand, oDataReader, Nothing, STAFF_CODE, STAFF_NAME, 2, oTran)
