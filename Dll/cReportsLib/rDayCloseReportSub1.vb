...
Public Class rDayCloseReportSub1
    ...
    Sub New(ByRef iConn As OleDb.OleDbConnection, _
        ...
        RECORD_CNT = oAdjustDBIO.getAdjust2(oAdjust, Nothing, Nothing, iCloseDate, "入金", "出金", oTran)
        oAdjustDBIO = Nothing
    End Sub
    ...
    ByRef iCommand As OleDb.OleDbCommand, _
    ByRef iDataReader As OleDb.OleDbDataReader, _
    ByRef iFromCode As String, _
    ByRef iToCode As String, _
    ByRef iCloseDate As String, _
    ByRef iTran As System.Data.OleDb.OleDbTransaction)
        ...
        FromAdjustCode = oAdjustDBIO.readMaxAdjustCode("レジ入金", iCloseDate, "<=", oTran)
        ToAdjustCode = oAdjustDBIO.readMaxAdjustCode(Nothing, iCloseDate, "<=", oTran)
        RECORD_CNT = oAdjustDBIO.getAdjust2(oAdjust, iFromCode, iToCode, Nothing, "入金", "出金", oTran)
        oAdjustDBIO = Nothing
    End Sub


    Private Sub rDayCloseReportSub1_DataInitialize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.DataInitialize
        Fields.Add("KANJYOU")
    ...
    Private Sub rDayCloseReportSub1_FetchData(ByVal sender As Object, ByVal eArgs As DataDynamics.ActiveReports.ActiveReport.FetchEventArgs) Handles Me.FetchData
