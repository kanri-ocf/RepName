...
Partial Class fMemberCardReportPage
    ...
    Private Sub InitializeComponent()
        ...
        Me.MESSAGE_1_T.Text = "会員カード出力を行います。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "出力先のプリンターデバイスを指定して下さい。"
