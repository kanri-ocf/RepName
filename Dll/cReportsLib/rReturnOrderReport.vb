Public Class rReturnOrderReport
    ...
    Private PostagePay As Long          '送料
    Private FeePay As Long              '手数料
    Private DiscountPay As Long         '値引き
    Private PointDiscountPay As Long    'ポイント値引き
    Private BrforeTotalPay As Long      '税抜合計金額
    Private TaxPay As Long              '消費税
    '2019,9,27 A.Komita 追加 From
    Private RedusedTaxPay As Long       '軽減税
    '2019,9,27 A.Komita 追加 To
    Private AfterTotalPay As Long       '税込合計金額
    ...
    Private Sub HEADER_INFO()
        ...
        '    Fields("TOTAL_BEFORE_TAX_PRICE").Value = oOrderData(0).sNoTaxTotalPrice + oOrderData(0).sShippingCharge + oOrderData(0).sPaymentCharge
        'Else
