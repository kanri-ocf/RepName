Public Class cDataOrderStatusDBIO
    ...
    Public Function getOrderStatus(ByRef parOrderStatus() As cStructureLib.sOrderStatus, _
        ...
        Try
            ...
            While pDataReader.Read()
                ...
                '選択状態
                parOrderStatus(i).sCheck = pDataReader("選択状態")

                '2019.12.1 R.Takashima FROM
                '数量を抽出するように変更
                '数量
                'parOrderStatus(i).sCount = pDataReader("選択状態")
                parOrderStatus(i).sCount = pDataReader("数量")
    ...
    Public Function insertOrderStatus(ByVal parOrderStatus As cStructureLib.sOrderStatus, _
        ...
        Try
            ...
            'SQL文の設定
            strInsert = "INSERT INTO 発注状態データ( 商品コード, 選択状態, 数量 ) VALUES ( " & _
                """" & parOrderStatus.sProductCode & """, " & _
                parOrderStatus.sCheck & ", " & _
                parOrderStatus.sCount & ") "
    ...
    Public Function updateOrderStatus(ByVal parOrderStatus As cStructureLib.sOrderStatus, _
        ...
        strUpdate = "UPDATE 発注状態データ " & _
                        "SET 選択状態 = " & parOrderStatus.sCheck & ", " & _
        ...
        Try
            ...
            pCommand.Parameters("@OrderStatus").Value = parOrderStatus.sCheck
            '数量
            pCommand.Parameters.Add _
