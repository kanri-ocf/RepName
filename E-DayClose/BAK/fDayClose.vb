Public Class fDayClose
    ...
    Private Function JURNAL_PRINTING() As Boolean
        ...
        RecordCount = oBumonDBIO.getBumonMst(oBumon, Nothing, Nothing, Nothing, Nothing, Nothing, oTran)
        ReDim BUMON_CNT(oBumon.Count - 1)
        ReDim BUMON_PRICE(oBumon.Count - 1)
    ...
    Private Function REPORT_PRINTING() As Boolean
        ...
        Dim oReportPage = New rDayCloseReport(oConn, oCommand, oDataReader, oCalc, oTrnSummary, STAFF_CODE, STAFF_NAME, CLOSE_DATE_T.Text, oTran)
