...
Public Class rMonthCloseReport
    ...
    Private Sub fMonthCloseReport_DataInitialize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.DataInitialize
        ' ヘッダー情報
    ...
    Private Sub fMonthCloseReport_FetchData(ByVal sender As Object, ByVal eArgs As DataDynamics.ActiveReports.ActiveReport.FetchEventArgs) Handles Me.FetchData
        '現金状況情報セット
        If RECORD_NO = 0 Then
            CASH_INFO()
            SUM_CAL_INFO()
    ...
    Private Sub CASH_INFO()
        ...
        RecordCount = oAdjustDBIO.getAdjust(oAdjust, AdjustCode, Nothing, Nothing, cStructureLib.GetAdjustMode.FromToAdjustCode, Nothing, oTran)
    ...
    Private Sub GroupFooter1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        Dim rpt As New rMonthCloseReportSub1(oConn, oCommand, oDataReader, CLOSE_DATE, oTran)
