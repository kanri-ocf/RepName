Public Class cMstSupplierDBIO
    ...
    ''　　　　False --> 取得するレコードなし
    ''----------------------------------------------------------------------
    Public Function getSupplier(ByRef parSupplier() As cStructureLib.sSupplier, ByVal KeySupplierCode As String, ByVal KeySupplierName As String, ByRef Tran As System.Data.OleDb.OleDbTransaction) As Long
    ...
    ''　　　　False --> 取得するレコードなし
    ''----------------------------------------------------------------------
    Public Function getSupplierCode(ByRef parSupplier() As cStructureLib.sSupplier, ByVal KeySupplierName As String, ByRef Tran As System.Data.OleDb.OleDbTransaction) As Long
        Dim i As Integer
        Dim StrSelect As String
    ...
    '----------------------------------------------------------------------
    Public Function insertSupplierMst(ByVal parSupplier As cStructureLib.sSupplier, _
        ...
        Try
            'SQL文の設定
            strInsert = "INSERT INTO 仕入先マスタ ( " & _
                            "仕入先コード, " & _
                            "仕入先名称, " & _
                            "郵便番号, " & _
                            "住所１, " & _
